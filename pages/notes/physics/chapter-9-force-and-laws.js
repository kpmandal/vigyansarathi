    ...
    <>
      ...
      <Head>
        ...
        <style jsx global>{`
          ...
          .study-guide-container hr { border: 0; height: 1px; background-image: linear-gradient(to right, rgba(0,0,0,0), rgba(0,0,0,0.1), rgba(0,0,0,0)); margin: 3.5em 0; }
          .study-guide-container h1, .study-guide-container h2, .study-guide-container h3 { font-family: 'Montserrat', sans-serif; font-weight: 800; line-height: 1.3; }
          .study-guide-container h1 { color: #1A237E; font-size: 2.5em; text-align: center; margin-bottom: 0.2em; }
          .study-guide-container h2 { color: #1a202c; font-size: 2em; margin-top: 1.8em; border-bottom: 3px solid #E8EAF6; padding-bottom: 10px; }
          .study-guide-container h3 { color: #283593; font-size: 1.5em; margin-top: 1.8em; }
          .study-guide-container p, .study-guide-container li { font-size: 1.1em; }
          .study-guide-container strong, .study-guide-container b { color: #0D47A1; font-weight: 700; }
          .post-meta { text-align: center; font-size: 1.1em; font-weight: 700; color: #1A237E; background-color: #E8EAF6; padding: 12px; border-radius: 8px; margin-bottom: 2em; }
          .fact-box, .exam-spotlight-box, .qa-box { margin: 2em 0; padding: 1.5em; border-radius: 8px; border-left: 8px solid; }
          .fact-box h4, .exam-spotlight-box h4, .qa-box h4 { margin-top: 0; font-family: 'Montserrat', sans-serif; font-size: 1.3em; }
          ...
          .styled-list li::before { content: '➤'; position: absolute; left: 0; color: #FFB300; font-size: 1.2em; top: 2px; }
          ...
          @media (min-width: 768px) {
              .study-guide-container { padding: 2.5em 4em; }
              .study-guide-container h1 { font-size: 3em; }
              .study-guide-container h2 { font-size: 2.4em; }
              .study-guide-container h3 { font-size: 1.7em; }
              .study-guide-container p, .study-guide-container li { font-size: 1.2em; }
          }
        `}</style>
      </Head>
        ...
        <div className="study-guide-container">
            ...
            <ol className="mcq-list">
                ...
                <li>A goalkeeper in a game of football pulls his hands backwards after holding the ball shot at the goal. This enables the goalkeeper to:
                    <span className="mcq-options"> A) Exert larger force on the ball   B) Reduce the force exerted by the ball on the hands   C) Increase the rate of change of momentum   D) Decrease the rate of change of momentum </span>
                </li>
